...
// Carrega .env sem depender do pacote dotenv (que nem sempre está na raiz).
// Procura em: raiz, bot/.env — primeiro arquivo encontrado é carregado.
// Variáveis já presentes em process.env têm precedência (não são sobrescritas).
